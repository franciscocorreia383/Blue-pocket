...
class DespesasMovimentationsAdapter(val context: Context, val listMovimentation: ArrayList<Movimentation>):RecyclerView.Adapter<DespesasMovimentationsViewHolder>(){
...
class DespesasMovimentationsViewHolder(view: View):RecyclerView.ViewHolder(view){
